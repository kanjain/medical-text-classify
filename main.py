...
def extract_features(train_data, train_label, test_data, stop_words):
    ...
    # ngram features: 1-gram, 2-gram, 3-gram, 4-gram.

    # Out of all the n-grams features, selected k=7000 most important features
    ...
    train_x_fit = selector.fit_transform(train_x_fit, train_label)
